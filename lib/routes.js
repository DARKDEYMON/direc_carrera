...
norm.route('/calificarbal/:id/:ges/:peri',{
    name:'calificarbal',
    action(){
...
norm.route('/calificarbaux/:ges/:peri/:mat/:ru',{
    name:'calificarbaux',
    action(){
        BlazeLayout.render("main",{body:"calificarbaux"})
    }
})
norm.route('/habverano',{
    name:"habverano",
    action(){
        BlazeLayout.render("main",{body:"habverano"})
    }
});
norm.route('/habveranodocente/:mat/:ges',{
    name:"habveranodocente",
    action(){
        BlazeLayout.render("main",{body:"habveranodocente"})
    }
});
//postulantes
norm.route('/listapostulantes',{
    name:"listapostulantes",
    action(){
        BlazeLayout.render("main",{body:"listapostulantes"})
    }
});
//para login todo
norm.route('/singup/',{
